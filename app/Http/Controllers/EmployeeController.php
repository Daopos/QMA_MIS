...
class EmployeeController extends Controller
{
    ...
    public function employeeResetPassword(Request $request, $id)
    {
        ...
        $loginUrl = 'https://yourapp.com/login'; // Replace with the actual login URL

        // Send the reset password notification
        $notification = new EmployeeResetPasswordNotification($employee, $fields['password'], $loginUrl);
        ...
        $teachers = Employee::where('type', 'Teacher') // Filter only Teachers
            ->with([
                ...
                'subjects' => function ($query) {
                    $query->with('schedules'); // Load the subjects and their schedules
                    $query->with('classroom'); // Load the subjects and their schedules
